...
SELECT name as Facilites_with_fees
FROM Facilities
WHERE membercost>0
...
in question. */
SELECT (CASE WHEN monthlymaintenance>100 THEN name ELSE NULL END) as expensive,
(CASE WHEN monthlymaintenance<100 THEN name ELSE NULL END) as cheap,
monthlymaintenance
FROM Facilities
